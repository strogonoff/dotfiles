...
hi FoldColumn   guibg=#1a1a1a guifg=grey14
"hi default Folded       guibg=#E6E6E6 guifg=DarkBlue
hi Folded       guifg=grey35 guibg=#1a1a1a
...
hi StatusLineNC gui=NONE guifg=Gray90 guibg=Gray20
...
hi VertSplit    gui=NONE guifg=Gray90 guibg=Gray10
if has("gui_macvim")
...
hi Identifier   gui=NONE guifg=#87A96B guibg=NONE
hi Ignore       gui=NONE guifg=bg guibg=NONE
hi PreProc      gui=NONE guifg=DodgerBlue3 guibg=NONE
hi Special      gui=NONE guifg=#9678B6 guibg=NONE
...
if &background == "dark"
  ...
  hi Statement    gui=bold guifg=#B57EDC guibg=NONE
